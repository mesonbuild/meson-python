...
.. envvar:: MESONPY_EDITABLE_VERBOSE
   ...
   .. admonition:: Check our guide
      ...
      Please check our :ref:`how-to-guides-editable-installs` guide
      for more information on how to use it.

.. envvar:: MACOSX_DEPLOYMENT_TARGET

   Specify the target macOS version. If this variable is set,
   ``meson-python`` will use the specified macOS version for the
